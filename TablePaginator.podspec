...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TablePaginator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Alex Kisel/TablePaginator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Alex Kisel' => 'alexander.kisel@brander.ua' }
  s.source           = { :git => 'https://github.com/Alex Kisel/TablePaginator.git', :tag => s.version.to_s }
